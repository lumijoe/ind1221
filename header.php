    ...
    <div class="header-inner" id="header-inner">
        ...
        <nav class="mega-menu megamenu-change-footer-nav" id="megamenu-change-footer-nav">
            <ul class="menu-list">
                ...
                <!-- ボタン -->
                <li class="menu-item menu-item-button">
                    <a href="<?php echo esc_url(home_url()); ?>" class="button item-level0ne" style="color: #fff !important;"><img src="https://lkcodetest.sakura.ne.jp/ind1221/wp-content/uploads/images/icon_book_white.svg" alt="" width="30" height="30">カタログ一覧</a>
                </li>
                <li class="menu-item menu-item-button">
