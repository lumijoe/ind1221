...
<footer class="footer">
    <div class="footer-inner text80">
        ...
        <div class="footer-section">
            ...
            <ul>
                <!-- <li><a href="<?php echo esc_url(home_url()); ?>/archives/news#newsNavtag-sustainability">サステナニュース</a></li> -->
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/products-search.js"></script>
