                ...
                <?php if (get_field('post_pdf') && get_field('post_pdf_title')) : ?>
                    <p class="pdf-title">
                        <a href="<?php the_field('post_pdf'); ?>" target="_blank" rel="noopener noreferrer">
                            <?php the_field('post_pdf_title'); ?><img src="https://lkcodetest.sakura.ne.jp/ind1221/wp-content/uploads/images/icon_pdf.svg" alt="" style="width:23px">
                        </a>
                    </p>
                <?php endif; ?>
                <!-- 外部リンク -->
...
<nav class="post-nav">
    <div class="post-nav-prev">
        ...
        if (!empty($prev_post)) :
            $prev_title = get_field('post_title', $prev_post->ID);
            $prev_img = get_field('post_imageurl', $prev_post->ID);
        ?>
    ...
    <div class="post-nav-next">
        ...
        if (!empty($next_post)) :
            $next_title = get_field('post_title', $next_post->ID);
            $next_img = get_field('post_imageurl', $next_post->ID);
        ?>
