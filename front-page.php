                        ...
                        <div class="news-list">
                            <div class="news-list-wrapper">
                                ...
                                <article class="news-item product">
                                    ...
                                    <a href="#" class="news-item-txt">新製品の発売に関するお知らせ「A群に対応する検査設備量産型『QE120』を開発フェーズから販売フェーズへ」</a>
                                </article>
                            </div>
                            ...
                            <div class="news-list-wrapper">
                                ...
                                <article class="news-item sustainability">
                                    ...
                                    <a href="#" class="news-item-txt">環境への取り組みについて更新しました「地域の海洋ゴミクリーンアップキャンペーン『CHANGE FOR FUTURE』を国内5カ所で展開」</a>
                                </article>
                            </div>
